...
class SilmaV2TTSModel(BaseTTSModel):
    ...
    display_name = "SILMA TTS v2 MSA"             # shown in the arena UI
    ...
    def stream_waveform(self, text, voice_id, creativity, speed):
        ...
        try:
            with persistent_session.post(api_url, json=payload, stream=True, headers=headers) as r:
                ...
                ##status code != 200
                    ...
                    try:
                        ...
                        raise Exception(f"HTTP Error {r.status_code}: {error_data.get('detail')}")
    ...
    def load_model(self):
        ...
        self.api_url = os.environ["API_URL_V2"]
